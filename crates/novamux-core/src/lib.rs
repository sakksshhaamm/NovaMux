...
pub use protocol::{
    DecodeError, ErrorCode, MAX_ERROR_MESSAGE_BYTES, MAX_FRAME_BYTES, MAX_LISTED_SESSIONS,
    PROTOCOL_VERSION, Request, Response, SessionInfo, decode_request, decode_response,
